...
xcopy buildEnv\lib\python3.9\site-packages\playwright\driver\package\.local-browsers\firefox-1323\firefox\* dist\LinkScope /S /Y
xcopy buildEnv\lib\python3.9\site-packages\playwright\driver\package\.local-browsers\firefox-1323\firefox\* dist\LinkScope\playwright\driver\package\.local-browsers\firefox-1323\firefox /S /Y
